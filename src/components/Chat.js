...
function Chat(props) {
  const fakeMessages = [
    { id: "1254", content: "Hello", senderID: "jOJpmz6s0xVz86npV8KrmJnYnFy2" },
    ...
    { id: "1256", content: "Good", senderID: "dAmZ6pW8CXPy4Dff2zJDxUqMy973" },
    {
      id: "1257",
    ...
    { id: "1212", content: "Sure!", senderID: "jOJpmz6s0xVz86npV8KrmJnYnFy2" },
    {
      id: "1241",
  ...
  // console.log(props);
  const { id: personUID, username } = props.person;
